...
export const Section = ({ title, icon, children, collapsible = false, defaultOpen = false, wide = false }) => {
  ...
  return (
    <div style={{ background: "var(--surface, #ffffff)", borderRadius: 12, padding: acik ? 24 : "18px 24px", boxShadow: "0 1px 4px rgba(0,0,0,.08)", marginBottom: 20, maxWidth: wide ? "100%" : 720 }}>
      <div
