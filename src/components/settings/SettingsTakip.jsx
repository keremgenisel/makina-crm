...
// Not: "Beklenen tahsilat penceresi" (tahsilatTakipGun) kaldırıldı — kullanıcı isteğiyle Beklenen
// Tahsilat kutusu artık pencere kısıtlaması olmadan tüm bekleyen çek/taksit/bloke kartı gösteriyor.
export const SettingsTakip = ({ appSettings = {}, setAppSettings = null, flash = () => {} }) => {
  ...
  const kaydet = () => {
    ...
    setTeklifGun(String(t1));
    setAppSettings?.(p => ({ ...p, teklifTakipGun: t1 }));
  ...
  return (
    <Section title="Takip Süreleri" icon="notes">
      ...
      {/* Sabit kolonlu grid: kutu ve metin aynı hizada başlar */}
