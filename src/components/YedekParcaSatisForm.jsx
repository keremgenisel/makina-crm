...
export const YedekParcaSatisForm = ({ title, form, setForm, dealers = [], customers = [], parts = [], partStock = [], calisanlar = [], onSave, onCancel, kdvRates = DEFAULT_KDV_RATES, draftBar = null, geoData = null, loadingGeo = false }) => {
  ...
  // Panoya gönderme iki yolla: "Fabrika Teslim" (fabrikaTeslim) VEYA "Kargo" (kargo). İkisi de kargoDurum'u
  // set eder (panoya düşürür); ayrımı fabrikaTeslim bayrağı yapar (panoda 🏭 FABRİKA TESLİM vs 📦 KARGO).
  ...
  return (
    <Modal title={title} onClose={onCancel} wide>
      ...
      {/* Panoya gönderme: üstte "Fabrika Teslim", altında "Kargo". İkisi de panoya düşürür (kargoDurum set);
          Fabrika Teslim işaretliyse panoda 🏭 FABRİKA TESLİM, Kargo'da 📦 KARGO görünür. Karşılıklı dışlarlar. */}
      <div style={{ marginTop: 12, border: "1px solid var(--n200, #e2e8f0)", borderRadius: 8, overflow: "hidden" }}>
        ...
        {panoda && (
          <div style={{ padding: 12, display: "grid", gap: 10, borderTop: "1px solid var(--n200, #e2e8f0)" }}>
            ...
            {kargoGonder && (
              <div style={{ borderTop: "2px dashed var(--ambBr3, #fed7aa)", marginTop: 2, paddingTop: 12 }}>
